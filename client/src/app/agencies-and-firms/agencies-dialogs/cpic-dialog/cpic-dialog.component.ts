...
import { CPICDialogCaseDetailsDialogComponent } from './cpic-dialog-case-details-dialog/cpic-dialog-case-details-dialog.component';
...
@Component({
  selector: 'app-cpic-dialog',
  templateUrl: './cpic-dialog.component.html',
  styleUrl: './cpic-dialog.component.scss'
})
export class CpicDialogComponent {
  ...
  constructor(private dialog: MatDialog, private dialogRef: MatDialogRef<CpicDialogComponent>) {}

  openCaseDetails(caseDetails: any) {
    this.selectedCase = caseDetails;
    this.isDetailDialogOpen = true;

    const dialogRef = this.dialog.open(CPICDialogCaseDetailsDialogComponent, {
      data: { caseDetails }
    });
