...
@Component({
  selector: 'app-cpic-dialog-case-details-dialog',
  templateUrl: './cpic-dialog-case-details-dialog.component.html',
  styleUrl: './cpic-dialog-case-details-dialog.component.scss'
})
export class CPICDialogCaseDetailsDialogComponent {
