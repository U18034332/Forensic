...
@Component({
  selector: 'app-sui-dialog-case-details-dialog',
  templateUrl: './sui-dialog-case-details-dialog.component.html',
  styleUrl: './sui-dialog-case-details-dialog.component.scss'
})
export class SUIDialogCaseDetailsDialogComponent {
