...
@Component({
  selector: 'app-dpci-dialog-case-details-dialog',
  templateUrl: './dpci-dialog-case-details-dialog.component.html',
  styleUrl: './dpci-dialog-case-details-dialog.component.scss'
})
export class DPCIDialogCaseDetailsDialogComponent {
