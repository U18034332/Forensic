...
@Component({
  selector: 'app-dsd-dialog-case-details-dialog',
  templateUrl: './dsd-dialog-case-details-dialog.component.html',
  styleUrl: './dsd-dialog-case-details-dialog.component.scss'
})
export class DSDDialogCaseDetailsDialogComponent {
