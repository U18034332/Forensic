...
@Component({
  selector: 'app-dtic-dialog-case-details-dialog',
  templateUrl: './dtic-dialog-case-details-dialog.component.html',
  styleUrl: './dtic-dialog-case-details-dialog.component.scss'
})
export class DTICDialogCaseDetailsDialogComponent {
