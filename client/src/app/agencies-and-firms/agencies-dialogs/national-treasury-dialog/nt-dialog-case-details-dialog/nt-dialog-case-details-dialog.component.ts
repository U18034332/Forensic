...
@Component({
  selector: 'app-nt-dialog-case-details-dialog',
  templateUrl: './nt-dialog-case-details-dialog.component.html',
  styleUrl: './nt-dialog-case-details-dialog.component.scss'
})
export class NTDialogCaseDetailsDialogComponent {
