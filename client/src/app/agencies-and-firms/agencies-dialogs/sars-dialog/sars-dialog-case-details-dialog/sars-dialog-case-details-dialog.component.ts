...
@Component({
  selector: 'app-sars-dialog-case-details-dialog',
  templateUrl: './sars-dialog-case-details-dialog.component.html',
  styleUrls: ['./sars-dialog-case-details-dialog.component.scss']
})
export class SARSDialogCaseDetailsDialogComponent implements OnInit{
