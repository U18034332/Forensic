...
import { SARSDialogCaseDetailsDialogComponent } from './sars-dialog-case-details-dialog/sars-dialog-case-details-dialog.component';
...
@Component({
  selector: 'app-sars-dialog',
  templateUrl: './sars-dialog.component.html',
  styleUrl: './sars-dialog.component.scss'
})
export class SarsDialogComponent {
  ...
  constructor(private dialog: MatDialog, private dialogRef: MatDialogRef<SarsDialogComponent>) {}

  openCaseDetails(caseDetails: any) {
    this.selectedCase = caseDetails;
    this.isDetailDialogOpen = true;

    const dialogRef = this.dialog.open(SARSDialogCaseDetailsDialogComponent, {
      data: { caseDetails }
    });
