...
@Component({
  selector: 'app-fundudzi-case-details-dialog',
  templateUrl: './fundudzi-case-details-dialog.component.html',
  styleUrl: './fundudzi-case-details-dialog.component.scss'
})
export class FundudziCaseDetailsDialogComponent {
