...
@Component({
  selector: 'app-frrim-case-details-dialog',
  templateUrl: './frrim-case-details-dialog.component.html',
  styleUrl: './frrim-case-details-dialog.component.scss'
})
export class FRRIMCaseDetailsDialogComponent {
