...
@Component({
  selector: 'app-gfia-case-details-dialog',
  templateUrl: './gfia-case-details-dialog.component.html',
  styleUrl: './gfia-case-details-dialog.component.scss'
})
export class GFIACaseDetailsDialogComponent {
