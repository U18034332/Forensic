...
import { GFIACaseDetailsDialogComponent } from './gfia-case-details-dialog/gfia-case-details-dialog.component';
...
@Component({
  selector: 'app-gfia-dialog',
  templateUrl: './gfia-dialog.component.html',
  styleUrl: './gfia-dialog.component.scss'
})
export class GfiaDialogComponent {
  ...
  constructor(private dialog: MatDialog, private dialogRef: MatDialogRef<GfiaDialogComponent>) {}

  openCaseDetails(caseDetails: any) {
    this.selectedCase = caseDetails;
    this.isDetailDialogOpen = true;

    const dialogRef = this.dialog.open(GFIACaseDetailsDialogComponent, {
      data: { caseDetails }
    });
