...
@Component({
  selector: 'app-ligwa-case-details-dialog',
  templateUrl: './ligwa-case-details-dialog.component.html',
  styleUrl: './ligwa-case-details-dialog.component.scss'
})
export class LIGWACaseDetailsDialogComponent {
