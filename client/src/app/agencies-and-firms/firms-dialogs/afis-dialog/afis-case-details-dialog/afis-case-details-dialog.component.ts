...
@Component({
  selector: 'app-afis-case-details-dialog',
  templateUrl: './afis-case-details-dialog.component.html',
  styleUrl: './afis-case-details-dialog.component.scss'
})
export class AFISCaseDetailsDialogComponent {
