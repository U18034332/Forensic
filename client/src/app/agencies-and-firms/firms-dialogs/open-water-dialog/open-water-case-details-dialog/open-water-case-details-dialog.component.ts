...
@Component({
  selector: 'app-open-water-case-details-dialog',
  templateUrl: './open-water-case-details-dialog.component.html',
  styleUrl: './open-water-case-details-dialog.component.scss'
})
export class OpenWaterCaseDetailsDialogComponent {
