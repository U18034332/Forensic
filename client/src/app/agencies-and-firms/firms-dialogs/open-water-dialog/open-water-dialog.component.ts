...
import { OpenWaterCaseDetailsDialogComponent } from './open-water-case-details-dialog/open-water-case-details-dialog.component';
...
@Component({
  selector: 'app-open-water-dialog',
  templateUrl: './open-water-dialog.component.html',
  styleUrl: './open-water-dialog.component.scss'
})
export class OpenWaterDialogComponent {
  ...
  constructor(private dialog: MatDialog, private dialogRef: MatDialogRef<OpenWaterDialogComponent>) {}

  openCaseDetails(caseDetails: any) {
    this.selectedCase = caseDetails;
    this.isDetailDialogOpen = true;

    const dialogRef = this.dialog.open(OpenWaterCaseDetailsDialogComponent, {
      data: { caseDetails }
    });
