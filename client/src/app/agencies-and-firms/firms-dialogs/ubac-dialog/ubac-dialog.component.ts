...
import { UBACCaseDetailsDialogComponent } from './ubac-case-details-dialog/ubac-case-details-dialog.component';
...
@Component({
  selector: 'app-ubac-dialog',
  templateUrl: './ubac-dialog.component.html',
  styleUrl: './ubac-dialog.component.scss'
})
export class UBACDialogComponent {
  ...
  constructor(private dialog: MatDialog, private dialogRef: MatDialogRef<UBACDialogComponent>) {}

  openCaseDetails(caseDetails: any) {
    this.selectedCase = caseDetails;
    this.isDetailDialogOpen = true;

    const dialogRef = this.dialog.open(UBACCaseDetailsDialogComponent, {
      data: { caseDetails }
    });
