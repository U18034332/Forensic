...
import { NexiaSABAndTCaseDetailsDialogComponent } from './nexia-sab-and-t-case-details-dialog/nexia-sab-and-t-case-details-dialog.component';
...
@Component({
  selector: 'app-nexia-sab-and-t-dialog',
  templateUrl: './nexia-sab-and-t-dialog.component.html',
  styleUrl: './nexia-sab-and-t-dialog.component.scss'
})
export class NexiaSabAndTDialogComponent {
  ...
  constructor(private dialog: MatDialog, private dialogRef: MatDialogRef<NexiaSabAndTDialogComponent>) {}

  openCaseDetails(caseDetails: any) {
    this.selectedCase = caseDetails;
    this.isDetailDialogOpen = true;

    const dialogRef = this.dialog.open(NexiaSABAndTCaseDetailsDialogComponent, {
      data: { caseDetails }
    });
