...
@Component({
  selector: 'app-nexia-sab-and-t-case-details-dialog',
  templateUrl: './nexia-sab-and-t-case-details-dialog.component.html',
  styleUrl: './nexia-sab-and-t-case-details-dialog.component.scss'
})
export class NexiaSABAndTCaseDetailsDialogComponent {
